...
#define OPCODE_OUT(opcode) \
	case opcode: \
		elog(DEBUG1, "%s", #opcode); \
		break

void
dprint_opcode(intptr_t opcode)
{
	...
	switch (opcode)
	{
			OPCODE_OUT(EEOP_DONE);
			OPCODE_OUT(EEOP_INNER_FETCHSOME);
			OPCODE_OUT(EEOP_OUTER_FETCHSOME);
			OPCODE_OUT(EEOP_SCAN_FETCHSOME);
			OPCODE_OUT(EEOP_INNER_VAR);
			OPCODE_OUT(EEOP_OUTER_VAR);
			OPCODE_OUT(EEOP_SCAN_VAR);
			OPCODE_OUT(EEOP_INNER_SYSVAR);
			OPCODE_OUT(EEOP_OUTER_SYSVAR);
			OPCODE_OUT(EEOP_SCAN_SYSVAR);
			OPCODE_OUT(EEOP_WHOLEROW);
			OPCODE_OUT(EEOP_ASSIGN_INNER_VAR);
			OPCODE_OUT(EEOP_ASSIGN_OUTER_VAR);
			OPCODE_OUT(EEOP_ASSIGN_SCAN_VAR);
			OPCODE_OUT(EEOP_ASSIGN_TMP);
			OPCODE_OUT(EEOP_ASSIGN_TMP_MAKE_RO);
			OPCODE_OUT(EEOP_CONST);
			OPCODE_OUT(EEOP_FUNCEXPR);
			OPCODE_OUT(EEOP_FUNCEXPR_STRICT);
			OPCODE_OUT(EEOP_FUNCEXPR_FUSAGE);
			OPCODE_OUT(EEOP_FUNCEXPR_STRICT_FUSAGE);
			OPCODE_OUT(EEOP_BOOL_AND_STEP_FIRST);
			OPCODE_OUT(EEOP_BOOL_AND_STEP);
			OPCODE_OUT(EEOP_BOOL_AND_STEP_LAST);
			OPCODE_OUT(EEOP_BOOL_OR_STEP_FIRST);
			OPCODE_OUT(EEOP_BOOL_OR_STEP);
			OPCODE_OUT(EEOP_BOOL_OR_STEP_LAST);
			OPCODE_OUT(EEOP_BOOL_NOT_STEP);
			OPCODE_OUT(EEOP_QUAL);
			OPCODE_OUT(EEOP_JUMP);
			OPCODE_OUT(EEOP_JUMP_IF_NULL);
			OPCODE_OUT(EEOP_JUMP_IF_NOT_NULL);
			OPCODE_OUT(EEOP_JUMP_IF_NOT_TRUE);
			OPCODE_OUT(EEOP_NULLTEST_ISNULL);
			OPCODE_OUT(EEOP_NULLTEST_ISNOTNULL);
			OPCODE_OUT(EEOP_NULLTEST_ROWISNULL);
			OPCODE_OUT(EEOP_NULLTEST_ROWISNOTNULL);
			OPCODE_OUT(EEOP_BOOLTEST_IS_TRUE);
			OPCODE_OUT(EEOP_BOOLTEST_IS_NOT_TRUE);
			OPCODE_OUT(EEOP_BOOLTEST_IS_FALSE);
			OPCODE_OUT(EEOP_BOOLTEST_IS_NOT_FALSE);
			OPCODE_OUT(EEOP_PARAM_EXEC);
			OPCODE_OUT(EEOP_PARAM_EXTERN);
			OPCODE_OUT(EEOP_PARAM_CALLBACK);
			OPCODE_OUT(EEOP_CASE_TESTVAL);
			OPCODE_OUT(EEOP_MAKE_READONLY);
			OPCODE_OUT(EEOP_IOCOERCE);
			OPCODE_OUT(EEOP_DISTINCT);
			OPCODE_OUT(EEOP_NOT_DISTINCT);
			OPCODE_OUT(EEOP_NULLIF);
			OPCODE_OUT(EEOP_SQLVALUEFUNCTION);
			OPCODE_OUT(EEOP_CURRENTOFEXPR);
			OPCODE_OUT(EEOP_NEXTVALUEEXPR);
			OPCODE_OUT(EEOP_ARRAYEXPR);
			OPCODE_OUT(EEOP_ARRAYCOERCE);
			OPCODE_OUT(EEOP_ROW);
			OPCODE_OUT(EEOP_ROWCOMPARE_FINAL);
			OPCODE_OUT(EEOP_MINMAX);
			OPCODE_OUT(EEOP_FIELDSELECT);
			OPCODE_OUT(EEOP_SBSREF_SUBSCRIPTS);
			OPCODE_OUT(EEOP_SBSREF_ASSIGN);
			OPCODE_OUT(EEOP_SBSREF_FETCH);
			OPCODE_OUT(EEOP_DOMAIN_TESTVAL);
			OPCODE_OUT(EEOP_DOMAIN_NOTNULL);
			OPCODE_OUT(EEOP_DOMAIN_CHECK);
			OPCODE_OUT(EEOP_CONVERT_ROWTYPE);
			OPCODE_OUT(EEOP_SCALARARRAYOP);
			OPCODE_OUT(EEOP_HASHED_SCALARARRAYOP);
			OPCODE_OUT(EEOP_XMLEXPR);
			OPCODE_OUT(EEOP_JSON_CONSTRUCTOR);
			OPCODE_OUT(EEOP_IS_JSON);
			OPCODE_OUT(EEOP_AGGREF);
			OPCODE_OUT(EEOP_GROUPING_FUNC);
			OPCODE_OUT(EEOP_WINDOW_FUNC);
			OPCODE_OUT(EEOP_SUBPLAN);
			OPCODE_OUT(EEOP_AGG_STRICT_DESERIALIZE);
			OPCODE_OUT(EEOP_AGG_DESERIALIZE);
			OPCODE_OUT(EEOP_AGG_STRICT_INPUT_CHECK_ARGS);
			OPCODE_OUT(EEOP_AGG_STRICT_INPUT_CHECK_NULLS);
			OPCODE_OUT(EEOP_AGG_PLAIN_PERGROUP_NULLCHECK);
			OPCODE_OUT(EEOP_AGG_PLAIN_TRANS_INIT_STRICT_BYVAL);
			OPCODE_OUT(EEOP_AGG_PLAIN_TRANS_STRICT_BYVAL);
			OPCODE_OUT(EEOP_AGG_PLAIN_TRANS_BYVAL);
			OPCODE_OUT(EEOP_AGG_PLAIN_TRANS_INIT_STRICT_BYREF);
			OPCODE_OUT(EEOP_AGG_PLAIN_TRANS_STRICT_BYREF);
			OPCODE_OUT(EEOP_AGG_PLAIN_TRANS_BYREF);
			OPCODE_OUT(EEOP_AGG_PRESORTED_DISTINCT_SINGLE);
			OPCODE_OUT(EEOP_AGG_PRESORTED_DISTINCT_MULTI);
			OPCODE_OUT(EEOP_AGG_ORDERED_TRANS_DATUM);
			OPCODE_OUT(EEOP_AGG_ORDERED_TRANS_TUPLE);
			OPCODE_OUT(EEOP_LAST);
	}
}
