...
PG_KEYWORD("dense_rank", DENSE_RANK, UNRESERVED_KEYWORD, BARE_LABEL)
...
PG_KEYWORD("keep", KEEP_P, UNRESERVED_KEYWORD, BARE_LABEL)
...
PG_KEYWORD("middle", MIDDLE, UNRESERVED_KEYWORD, AS_LABEL)
